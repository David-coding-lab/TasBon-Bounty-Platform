            ...
            <div className="flex flex-col gap-1 pt-3">
              {navLinks.map((item) => (
                <a
                  key={item.name}
                  href="#"
                  className="px-2 py-2 text-gray-600 hover:text-gray-900 text-sm font-medium rounded-md hover:bg-gray-50 transition-colors"
                >
                  {item.name}
                </a>
              ))}
              <div className="flex gap-3 pt-3 px-2">
                <a href="/signin" className="text-sm text-gray-600 font-medium">
                  Login
                </a>
