              ...
              <div className="signup-field-reveal">
                <div className="relative">
                  <input
                    ...
                    disabled={isLoading}
                    className={`w-full px-4 py-3 pr-12 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 disabled:opacity-50 disabled:cursor-not-allowed ${
